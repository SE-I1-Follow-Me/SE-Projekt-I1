...
Im Entwurf entschieden wir auf dieser Grundlage, dass alle Daten zentral in einer MySQL Server Datenbank gespeichert werden. Diese eignet sich gut für die von uns zu speichern
