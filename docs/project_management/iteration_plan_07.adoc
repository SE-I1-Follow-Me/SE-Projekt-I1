...
| Einarbeiten in JPA, UC01 implementieren | hoch | 5 | 16.05.23 | - | 7 | Jonas Pfeiffer, Michael Novak | - | -
| Einfügen eines Markers an der aktuellen GPS Koordinate, Aufzeichnen der Route (UC04 & UC05) | hoch | 5 | 16.05.23 | - | 7 | Leon Lowa, Manuel Scheer | - | -
| Teilnahme an Meetings, Klärung offener Fragen | medium | 2 | 05.05.23 | - | 7 | Magnus Andreas Böhne, Manuel Scheer | - | -
| Erstellen und Überarbeitung der Protokolle / Iterationsplänen | medium | 2 | 09.05.23 | - | 7 | Manuel Scheer | - | - 
| GitHub Action & Autostart (nachholen) | low | 2 | 16.05.23 | - | 6 | Magnus Andreas Böhne  | - | -
| Spring Boot Security aufsetzen & Sicherheitslücken schließen | medium | 4 | 16.05.23 | - | 7 | Magnus Andreas Böhne | - | -
|===
