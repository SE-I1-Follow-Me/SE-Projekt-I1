...
| Aufsetzen Springboot für den Server (Spring Security) | high | 4 | 18.04.23 | - | 5 | Magnus Andreas Böhne, Manuel Scheer | - | -
| Anpassung NFAU3, Risiko ID 7 und 8 | low | 1 | 18.04.2023 | - | 5 | Michael Novak | - | - |
|===
