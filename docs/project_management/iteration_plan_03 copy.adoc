...
* Use-Cases initial ausarbeiten (inkl. Diagramme)
* initialen Projektplan erstellen
* Risikoliste
* Systemweite Requirements definieren
...
Die in dieser Iteration geplanten Aufgaben sind in den https://github.com/TitanKnife/SE-Projekt-I1/issues[GitHub-Issues] mit entsprechenden Meilensteinen gekennzeichnet.
