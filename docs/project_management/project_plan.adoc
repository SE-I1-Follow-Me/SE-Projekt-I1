...
Die serverseitigen Komponenten der Anwendung werden auf einem Server der HTW-Dresden betrieben. Die Anwendung in Form einer Android-App wird nach Fertigstellung in dem offiziellen Google-Play-Store zum Download bereitstehen. 
