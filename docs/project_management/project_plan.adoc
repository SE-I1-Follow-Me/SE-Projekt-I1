...
Die serverseitigen Komponenten der Anwendung werden auf eine Server der HTW-Dresden betrieben. Die Anwendung in Form einer Android-App wird nach Fertigstellung in dem ofiziellen Google-Play-Store zum download bereit stehen. 
...
- die tools und die projektmanagementmethode hätten von anfang an bekannt sein müssen. Spätere Methodenänderungen sind schwer etablierbar. Issues hätte vollständig beherrscht werden müssen und vielleicht lieber ein vernünftiges Kanbantool genutzt werden müssen (vgl. Taiga)
- mehr feedback vom kunden
- essence manager benutzen
- probleme nicht nur in den wöchentlichen meetings sondern dauerhaft und direkt ansprechen
- Use-Cases nicht agil genug entwickelt
- auf den aufwand hätte man mehr rücksicht nehmen müssen-> mehr leute für schwere aufgaben
- terminfindungstools könnten genutzt werden
