...
| UC07 Route speichern umsetzen (lokal mit Autosync) | hoch | 4 | 10.06.23 | - | 9 | Leon Lowa, Manuel Scheer | - | -
| JPA einsatzbereit (UC04, UC06, UC07, UC02) | hoch | 4 | 10.06.23 | - | 9 | Michael Novak, Jonas Pfeiffer | - | -
| Spring Security | hoch | 4 | 10.06.23 | - | 9 | Magnus Andreas Böhne | - | -
|===
