...
<<<
include::Use Case 06 - Route speichern.adoc[]

<<<
include::Use Case 07 - Route bearbeiten.adoc[]

<<<
include::Use Case 08 - Route löschen.adoc[]

<<<
include::Use Case 09 - Route ablaufen.adoc[]

<<<
include::Use Case 10 - Roboter warten.adoc[]
