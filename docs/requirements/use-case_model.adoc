...
* *UC01*: Speichern der Roboter
* *UC02*: Verwalten der Roboter
* *UC03*: Auswahl der Roboter
* *UC04*: Beenden der Follow-Me Funktion
* *UC05*: Senden des Folge Befehls
* *UC06*: Senden des Zurückkehren Befehls
* *UC07*: Senden des Warte Befehls
* *UC08*: Speichern der Route
* *UC09*: Warten der Roboter
* *UC10*: Verwalten der Routen
