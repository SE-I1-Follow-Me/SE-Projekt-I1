...
| Kanban | Kanban ist eine Methode des Agilen Projektmanagments, wobei Aufgaben in kleine Schritte geteilt und nacheinander abgearbeitet werden | Kanbanboard, Kanbantool
