...
|Fahrroboter |Bei den in anderen Dokumenten angesprochenen Fahrrobotern handelt es sich um Fahrroboter der Firma Sciota Robotics. Weitere Informationen können  https://sciota-robotics.com/de/sciota-robotics-for-outdoor-applications-deutsch/[hier]
gefunden werden  |
...
| Sourcecode | Sourcecode ist lesbarer Text einer Progammiersprache | Quellcode, Quelltext, Programmcode
...
| Simulationsystem | Eine Windows Applikation die den Roboter für testzwecke simuliert |
