...
| betrifft | Kunden die einen Fahrroboter besitzen.
| die Auswirkung davon ist | Fahrrobotern können keine Aufgaben übertragen werden.
...
|===
| Für | Kunden
| die | die einen Fahrroboter besitzen
| Das Produkt ist eine | mobile Android-App
| Die | es dem Kunden ermöglicht, die Fahrroboter zu bedienen
| Im Gegensatz zu | Lasten selbstständig tragen
| Unser Produkt | ermöglicht es, diese Aufgaben an den Fahrroboter zu geben
|===
...
|Im Falle eines Absturzes werden die vollständigen, aufgenommenen Daten gespeichert |hoch | 
...
|In der Sprachauswahl soll neben Deutsch auch Englisch vergügbar sein |niedrig |
|===
