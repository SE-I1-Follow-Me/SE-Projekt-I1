...
| Route aufzeichnen | hoch | Route abgehen und dabei aufzeichnen | SS 2023
...
|Route bearbeiten |hoch |Namen der Route ändern oder sie für andere Roboter zugänglich machen | SS 2023
|Route löschen |hoch |Löschen einer zuvor aufgenommenen Route | SS 2023
...
|Roboter Fahrkommandos |niedrig |Befehle auf aufgezeichneten Routen an den Roboter geben | SS 2023
|Roboter löschen |niedrig |Roboter aus der Liste der gespeicherten Roboter entfernen | SS 2023
|Roboter in Wartungsmodus setzen |sehr niedrig | SS 2023Roboter wird in Warungsmodus gesetzt; er steht damit bis zur Deaktivierung des Modus nicht zur Verfügung | SS 2023
|===
...
|Da die App auch nach Fertigstellung weiter entwickelt werden soll muss im Code möglichst auf hartcodierung verzichtet werden |hoch | SS 2023
|Das Speichern der Daten auf dem Server soll bei stabiler Internetverbindung nicht länger als 5 Sekunden dauern |mittel | SS 2023
|Die App muss so entwickelt werden, dass eine Sprachauswahl möglich ist |mittel | SS 2023
