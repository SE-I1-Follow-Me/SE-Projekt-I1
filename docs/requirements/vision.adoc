...
Für Teile der Implementierung greift das Team I1 auf die GPS-Tracking-Android-App zurück, welche im vorangegangenen Projektzyklus vom Team I5 entwickelt wurde. Diese App ermöglicht GPS-Tracks zu erstellen.
