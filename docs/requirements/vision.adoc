...
Dieses Visions-Dokument bezieht sich auf die Follow-me Android-App für Fahrroboter, das vom Tema I1 entwickelt wird. Die Android-App wird es der Firma Sciota Robotics und dessen Kunden, welche vorerst aus Förster und Bauern bestehen, erlauben soll einen Fahrroboter für Fahrten auf Basis einer Follow-ME Funktion zu nutzen. Die Zielsetzung resultiert darin, das Bewegen von verschiedenen Gütern dem Menschen abzunehmen und so z.B. das Transportieren von Baumstämmen zu erleichtern.
...
| Ein Robotor darf nicht überall fahren und muss sich an gegebene Vorschriften halten bzw. in einem Gebiet eingesetzt werden in dem eventuelle Vorschriften nicht gelten.
