...
Der Auftraggeber sucht nach einer Funktion, welche eine Basis bietet, um zukünftig mit den Fahrrobotern arbeiten zu können. Deshalb benötigt er eine App, welche für den Outdoorbereich geeinget ist und es ermöglicht, die Roboter auch aus der Ferne zu steuern.
...
| betrifft | Nutzern, welche Aufgaben an die Fahrroboter deligieren möchten.
...
| Nutzer (Förster, Bauern)
| Nutzer der App, welche die Fahrroboter im Berufsalltag nutzen möchten
...
. Die App wird auf der aktuell gängigen Android Version 11 entwickelt. Somit muss der Nutzer ein Endgerät mit dieser oder einer kompatiblen Version nutzen, um die Funktion der App zu gewährleisten. 
