...
Der Auftraggeber sucht nach einer Funktion, welche eine Basis bietet, um zukünftig mit den Fahrrobotern arbeiten zu können. Deshalb benötigt er eine App, welche für den Outdoorbereich geeinget ist, sowie eine Serveranbindung für selbige.
