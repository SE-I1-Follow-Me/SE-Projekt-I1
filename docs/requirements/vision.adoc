...
Dieses Visions-Dokument bezieht sich auf die Follow-me Android-App für Fahrroboter, welche von Team I1 entwickelt wird. Die Android-App wird ein Prototyp sein, um eine App zu entwickeln, welches es Kunden, zum Beispiel Förstern oder Bauern, ermöglichen wird, einem Fahrroboter zu befehlen ihnen zu folgen und auf dem absolvierten Pfad selbstständig verschiedenste Fahrtkomandos durchzuführen. Ziel des Projektes ist es, eine funktionierende App, welche Daten über den Aufenthalt sammelt, an einen Server schickt und von selbigen auch Daten empfangen und auslesen kann, zu entwickeln.
...
Für Teile der Implementierung greift das Team I1 auf die GPS-Tracking-Android-App zurück, welche im vorangegangenen Projektzyklus vom Team I5 entwickelt wurde. Diese App ermöglicht GPS-Tracks zu erstellen und ist wie dieses Projekt ein Prototyp für die eigentliche Follow-me Funktions-App. 
...
| Bereitstellung des benötigten Speichers; Zuverlässigkeit
