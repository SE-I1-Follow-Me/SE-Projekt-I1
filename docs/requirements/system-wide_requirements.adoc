...
NFAR-1: :: 
* Bei instabiler Verbundung zum Server sollen nur vollständig und korrekt gesendete Befehle/Operationen ausgeführt werden.
...
Zur Überprüfung wird ein solcher Fehler simuliert und überprüft ob die Entwickler über diesen Informiert wurden.
