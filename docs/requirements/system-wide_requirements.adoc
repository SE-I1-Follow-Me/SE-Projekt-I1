...
SWFA-4: ::
* Die App soll dauerhaft im jeweiligen Menü die Liste der Roboter beziehungsweise die Liste der Routen anzeigen.
...
* Die Verwaltung der Dokumentation und des Sourcecodes muss mittles gitHub erfolgen
* Das Framework Spring Boot soll verwendet werden
...
=== Interfance Requirements
NFAI-1: ::
* Text sollte auf dem Smartphone noch auf 50cm lesbar sein. Zur Überprüfung laden sich Teammitglieder die App herunter und testen die Lesbarkeit.
...
* Die App darf nur notwendige Daten an den Server schicken um den Datenschutz der Nutzer zu gewährleisten.
