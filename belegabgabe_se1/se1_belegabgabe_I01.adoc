...
// --- 2. Teammitglieder -----------------------
Carl Ulrich Brinker <s81041@htw-dresden.de>; Marcel Axmann <s83731@htw-dresden.de>; Michael Novak <s83875@htw-dresden.de>; Magnus Andreas Böhne <s83812@htw-dresden.de>; Manuel Scheer <s83818@htw-dresden.de>; Leon Lowa <s83824@htw-dresden.de>; Jonas Pfeiffer <s83836@htw-dresden.de>
// --- 3. Abgabedatum --------------------------
27. Januar 2022
// ---------------------------------------------
:docs: ../docs
...
<<<
// Wireframes
include::{docs-requirements}/VA_Wireframes.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
// System-wide Requirements
