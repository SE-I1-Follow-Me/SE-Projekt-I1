...
|UC03: Roboter löschen | Roboter können aus der App gelöscht werden
...
|===
|Use Case | Anmerkung
| UC02: Roboter bearbeiten | Da die Namen auf dem Server nicht in der App angepasst werden können ist diese Funktion nur bedingt umgesetzt
...
| nein
| Die Lizens wurde zur Apache License 2.0 geändert. 
...
Die Lizens des Produktes wurde zur Apache License 2.0 geändert. 
