= Iteration 08: {Projektname} (16.05.2023 - 30.05.2023) [MS]
...
Zudem entschieden wir uns für die Entwicklung einer physischen Sicht sowie einer logischen Sicht.

.image:Images/physische_Sicht.png
