...
=== Referenzen
Die im vorangegangenen Projektzyklus von Team I5 entwickelte App https://github.com/MarioNeugebauer/GpsTrackingAndroid[GPS-Tracking-Android-App], stellte sich im Laufe des Projekts als nicht nützlich heraus, da diverse Funktionen in der zu entwickelnden App nicht lauffähig sind.  
...
|Route laden |hoch |Zuvor aufgenommene Route anzeigen | offen
...
|Im Falle eines Absturzes werden die vollständig aufgenommenen Daten gespeichert |hoch | offen
