...
Dieses Visions-Dokument bezieht sich auf die Follow-me Android-App für Fahrroboter, welche von Team I1 entwickelt wird. Ziel des Projektes ist es, eine funktionierende App, welche via GPS, Daten über eine absolvierte Route sammelt, als auch ein Roboter-Management System bereit zu stellen. Vom Server sollen alle Daten zu Robotern und Routen empfangen und in der App asugelesen werden, als auch zu speichernde neue Daten an diesen zu senden.
...
=== Referenzen
Die im vorangegangenen Projektzyklus von Team I5 entwickelte App https://github.com/MarioNeugebauer/GpsTrackingAndroid[GPS-Tracking-Android-App], stellte sich im Laufe des Projekts als nicht nützlich heraus, da diverse Funktionen in der von uns zu entwickelnden App nicht lauffähig sind.  

== Positionierung

=== Fachliche Motivation
Der Auftraggeber sucht nach einer Funktion, welche eine Basis bietet, um zukünftig mit Fahrrobotern arbeiten zu können. Deshalb benötigt er eine App, welche für den Outdoorbereich geeignet ist und es ermöglicht, die Roboter auch aus der Ferne zu steuern.
...
| Im Gegensatz zu | das Routen und Roboter weder verwaltet noch hinzugefügt werden können
...
[%header, cols="4,1,4,1"]
|===
| Bedarf | Priorität | Features | Release
|Follow-me Funktion | sehr hoch |Der Nutzer kann einem oder mehreren Robotern den Befehl geben, ihm zu folgen. Dabei wird zudem die Route aufgezeichnet, welche im Anschluss gespeichert oder verworfen werden kann.| SS 2023
| Route aufzeichnen | hoch | Route während der Follow-me Funktion aufzeichnen | SS 2023
|Route an Server senden |hoch |Aufgenommene Route an den Server senden und auf diesem speichern | offen
|Roboter hinzufügen |hoch |Speichern eines neuen Roboters | SS 2023
|Route laden |mittel |Zuvor aufgenommene Route anzeigen | offen
|Route bearbeiten | niedrig |Namen der Route ändern oder sie für andere Roboter zugänglich machen | offen
|Route löschen | niedrig |Löschen einer zuvor aufgenommenen Route | offen
|Roboter bearbeiten |niedrig |Namen des Roboters ändern | SS 2023
|Roboter Fahrkommandos |niedrig |Befehle, die das Ablaufen einer Route betreffen (beginnen, pausieren, beenden) | offen
...
|Im Falle eines Absturzes werden die vollständig aufgenommenen Daten gespeichert |niedrig | offen
|Die App muss so entwickelt werden, dass eine Sprachauswahl möglich ist |sehr niedrig | offen
|===
